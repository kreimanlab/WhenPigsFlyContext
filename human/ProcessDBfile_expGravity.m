...
csvname = 'csv/results_gravity.csv';
system(['sqlite3 -header -csv db/expGravity.db "select * from expGravity;" > ' csvname]);

fid = fopen(csvname);
out = textscan(fid,'%s');
strtotal = out{1,1};
pattern = 'http://kreimanlab.com/mengmiMturkHost/VirtualHome/keyframe_VH_gravity_gif/';

savefilename = 'Mat/mturk_expGravity.mat';
