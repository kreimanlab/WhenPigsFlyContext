...
#python3 test_exp_I.py --uncertainty_threshold 0 --outname "test_exp_I_0" --weighted_prediction
#python3 test_exp_I.py --uncertainty_threshold 0 --outname "test_exp_I_1" --unweighted_prediction
#python3 test_exp_I.py --uncertainty_threshold 1 --outname "test_exp_I_2" --unweighted_prediction
#
#python3 test_exp_J.py --uncertainty_threshold 0 --outname "test_exp_J_0" --weighted_prediction
#python3 test_exp_J.py --uncertainty_threshold 0 --outname "test_exp_J_1" --unweighted_prediction
#python3 test_exp_J.py --uncertainty_threshold 1 --outname "test_exp_J_2" --unweighted_prediction

scores_all = ["test_exp_J_0_individual_scores.json", "test_exp_I_0_individual_scores.json"]
...
plt.title("CRT, threshold = 1, unweighted prediction")
