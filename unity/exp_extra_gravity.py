...
NumResCam = 6 #number of cameras generated on a circle centered at target locations
...
#classes where the number of images per class is less than 50
wantedClass = ['coffeemaker', 'cutlets', 'keyboard', 'pillow', 'toothbrush', 'toothpaste', 'washingsponge']
print(wantedClass)
...
stimulusdirname = rootdir + 'stimulus_extratest_gravity'
jasondirname = rootdir + 'jason_extratest_gravity'
...
##############################################################
    ...
    for i, target_xoffset in enumerate(Target_xoffset):
        ...
        circ, camYStepSz, targetYStepSz = FindOptimalCamTargetConfig_gravity(avgtargetsize, targetYpos, NumResCam)
        ...
        for c, circ_coor in enumerate(circ): #camera revolving along a circle cnetered at target
            ...
            try:
                ...
                pos = [target_xoffset, targetYStepSz, Target_zoffset[i]] #move object 1 meter up
