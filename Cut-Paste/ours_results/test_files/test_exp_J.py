...
if __name__ == "__main__":
    ...
    parser.add_argument("--outname", type=str, default="test_exp_J", help="Name used for the output file: outname_accuracies.json, outname_individual_scores.json")

    parser.add_argument("--annotations", type=str, default='/home/dimitar/experiments_I_and_J/annotations/test_annotations_exp_J.json',  help="Path to COCO-style annotations file.")
    parser.add_argument("--imagedir", type=str, default="/home/mengmi/Projects/Proj_context2/Matlab/Stimulus/keyframe_expH", help="Path to images folder w.r.t. which filenames are specified in the annotations.")
