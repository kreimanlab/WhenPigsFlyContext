...
imagedir_ori = '/home/mengmi/Projects/Proj_context2/Matlab/Stimulus/keyframe_expA'
...
object_data = pandas.read_csv('/home/dimitar/experiments_I_and_J/expIJ/test_expI_Color_oriimg.txt', header=-1)
binary_data = pandas.read_csv('/home/dimitar/experiments_I_and_J/expIJ/test_expI_Color_binimg.txt', header=-1)
labels = pandas.read_csv('/home/dimitar/experiments_I_and_J/expIJ/test_expI_Color_label.txt', header=-1)
...
# save annotations
with open("annotations/test_annotations_exp_I.json", "w") as f:
