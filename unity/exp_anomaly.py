...
stimulusdirname = rootdir + 'stimulus_anomaly'
jasondirname = rootdir + 'jason_anomaly'
...
#            continue 
    ...
    #            print(JasonData)
            #target_id = 354
            status, targetarea, img_inst_target_cv2 = displayTargetBbox(img_height, img_width, JasonData, img_ori_np, target_id, textflag=False, boxflag=True)
    #            print(target_id)
