...
csvname = 'csv/results_GTlabel_unrel.csv';
system(['sqlite3 -header -csv db/GTlabel_Unrel.db "select * from GTlabel_Unrel;" > ' csvname]);

fid = fopen(csvname);
out = textscan(fid,'%s');
strtotal = out{1,1};
pattern = 'http://kreimanlab.com/mengmiMturkHost/Unrel/';

savefilename = 'Mat/mturk_GTlabel_unrel.mat';
