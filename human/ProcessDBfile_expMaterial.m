...
csvname = 'csv/results_material.csv';
system(['sqlite3 -header -csv db/expMaterial.db "select * from expMaterial;" > ' csvname]);

fid = fopen(csvname);
out = textscan(fid,'%s');
strtotal = out{1,1};
pattern = 'http://kreimanlab.com/mengmiMturkHost/VirtualHome/keyframe_VH_material_gif/';

savefilename = 'Mat/mturk_expMaterial.mat';
