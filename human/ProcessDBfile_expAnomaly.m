...
csvname = 'csv/results_Anomaly.csv';
system(['sqlite3 -header -csv db/expAnomaly.db "select * from expAnomaly;" > ' csvname]);

fid = fopen(csvname);
out = textscan(fid,'%s');
strtotal = out{1,1};
pattern = 'http://kreimanlab.com/mengmiMturkHost/VirtualHome/keyframe_VH_anomaly_gif/';

savefilename = 'Mat/mturk_expAnomaly.mat';
