...
def test(model, annotations_file, image_dir, image_size, output_dir, epoch=None, record_individual_scores=False, print_batch_metrics=False):
    ...
    if epoch is not None:
        ...
        test_accuracy.save(output_dir, name="test_accuracies_epoch_10_exp_I")

    if record_individual_scores:
        individual_scores.save(output_dir, name="individual_scores_epoch_10_exp_I")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--annotations_file", type=str, default='/home/dimitar/experiments_I_and_J/annotations/test_annotations_exp_I.json', help="Path to COCO-style annotations file.")
