...
NumResCam = 12 #number of cameras generated on a circle centered at target locations
...
stimulusdirname = rootdir + 'stimulus_train_3'
jasondirname = rootdir + 'jason_train_3'
...
##############################################################
    ...
    for i, target_xoffset in enumerate(Target_xoffset):
        ...
        circ, radius, pitch, yaw = FindOptimalCamTargetConfig_trained2(avgtargetsize, targetYpos, NumResCam)
        #print(circ)
        #print(radius)
