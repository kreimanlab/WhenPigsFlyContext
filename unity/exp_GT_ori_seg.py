...
stimulusdirname =rootdir +  'stimulus_2_ori_seg'
jasondirname = rootdir + 'jason_2_ori_seg'
#graphdirname = 'GraphHuman_2_ori'
...
##############################################################
    ...
    for node in origraph['nodes']:
        ...
        #            print(JasonData)
                ...
                status, targetarea, targetbbox, img_inst_target_cv2 = segmentTargetBbox(img_height, img_width, JasonData, img_inst_np, target_id)
        #            print(target_id)
        ...
        #            exit()
                ...
                storeinfor['graphname']= None
                storeinfor['dest_surf'] = None
        ...
        #            print('Snapshot saved in demo/'+ "img_" + str(target_id) + "_prefab_" + targetprefabname + "_initial.png")
            ...
            if int(len(sort_index)*propFirstN) > 1:
                print('saving images...')
                imageprefix = "img_" + str(target_id) + "_prefab_" + targetprefabname + "_all_original_cam_"
                imgformat = ".png"
