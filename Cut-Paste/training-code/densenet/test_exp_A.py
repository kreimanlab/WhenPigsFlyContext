...
def test(model, annotations_file, image_dir, image_size, output_dir, epoch=None, record_individual_scores=False, print_batch_metrics=False):
    ...
    if epoch is not None:
        ...
        test_accuracy.save(output_dir, name="test_accuracies_epoch_20_exp_A")

    if record_individual_scores:
        individual_scores.save(output_dir, name="individual_scores_epoch_20_exp_A")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="/home/dimitar/densenet-master/output/checkpoint_20.tar", help="Path to model checkpoint.")
    parser.add_argument("--annotations_file", type=str, default='/home/dimitar/test_annotations_exp_A.json', help="Path to COCO-style annotations file.")
    parser.add_argument("--image_dir", type=str, default="/home/mengmi/Projects/Proj_context2/Matlab/Stimulus/keyframe_expA", help="Path to images folder.")
