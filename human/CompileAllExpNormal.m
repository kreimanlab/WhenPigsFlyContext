...
for i = startingMturkData:length(mturkData)
    ...
    infor = importdata(['/home/mengmi/Projects/Proj_context3/VirtualHome/matlab/MturkSets/exp_normal/mturkSet_' num2str(type) '.txt']);
...
for i = 1:length(VHhumanStats)
    ...
    VHhumanStats(i).GIFresponseNormal = HResponselist(indselected);
