...
load(['Mat/VHhumanStats_material.mat']);
...
expname = 'expMaterial';
load(['Mat/mturk_expMaterial.mat']);
...
for i = startingMturkData:length(mturkData)
    ...
    infor = importdata(['/home/mengmi/Projects/Proj_context3/VirtualHome/matlab/MturkSets/exp_material/mturkSet_' num2str(type) '.txt']);
