...
csvname = 'csv/results_GTlabel.csv';
system(['sqlite3 -header -csv db/GTlabel.db "select * from GTlabel;" > ' csvname]);

fid = fopen(csvname);
out = textscan(fid,'%s');
strtotal = out{1,1};
pattern = 'http://kreimanlab.com/mengmiMturkHost/VirtualHome/GT2/';

savefilename = 'Mat/mturk_GTlabel.mat';
