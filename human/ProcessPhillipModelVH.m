...
baselinelist = {'our','CATNet','Faster_R-CNN','DenseNet'};
...
for b = [1:length(baselinelist)]
    for selected = [1:length(condlist)]
        ...
        Pjason = readtable(['/home/mengmi/Projects/Proj_context3/VirtualHome/matlab/Mat/Pjason_' baselinelist{b} '_' condlist{selected} '.csv'], opts);
...
save(['Mat/modelresult.mat'],'modelresult','modelresult_std');
